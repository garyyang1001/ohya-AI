...
export const content: AIContent = {
    ...
    painPoints: {
        title: "為什麼企業導入 AI 困難重重？",
        subtitle: "如果您發現自己陷入以下徵兆，那麼問題不在於員工，而在於您的生意模式。",
        items: [
            {
                icon: "UserFocus",
                title: "Symptom 1: 老闆是唯一的瓶頸",
                description: "每一個決策都在等您拍板。您是全公司最聰明的人，而這正是最大的風險。公司離開了您，就停止運轉。",
            },
            {
                icon: "Shuffle",
                title: "Symptom 2: 無效的訓練輪迴",
                description: "您請人、訓練、他們離開、您崩潰。您花費大量時間在重複教導基礎知識，卻沒有留下一套可被執行的系統。",
            },
            {
                icon: "Search",
                title: "Symptom 3: 隱性知識的斷層",
                description: "最好的 SOP 卡在您的腦袋裡，或是資深員工的經驗法則中。這些「直覺」無法被複製，導致品質永遠無法標準化。",
            },
        ],
    },
    solution: {
        title: "我們如何協助企業成功導入 AI",
        subtitle: "我們的目標不是賣給您更多軟體，而是協助您完成「企業知識資產化」。將您的直覺 (Gut Feeling) 轉換為可以被同事重複使用的 AI 知識庫。",
        features: [
            {
