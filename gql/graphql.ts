...
/** The RankMath SEO meta settings for 分類. */
...
export type MediaItem = ContentNode & DatabaseIdentifier & HierarchicalContentNode & HierarchicalNode & Node & NodeWithAuthor & NodeWithRankMathSeo & NodeWithTemplate & NodeWithTitle & UniformResourceIdentifiable & {
...
export type Page = ContentNode & DatabaseIdentifier & HierarchicalContentNode & HierarchicalNode & MenuItemLinkable & Node & NodeWithAuthor & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithPageAttributes & NodeWithRankMathSeo & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Page';
  /** Returns ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
  ancestors?: Maybe<HierarchicalContentNodeToContentNodeAncestorsConnection>;
  /** Connection between the NodeWithAuthor type and the User type */
...
/** The RankMath SEO meta settings for 頁面. */
export type PageMetaSettings = RankMathMetaSettingWithRobots & {
  ...
  /** Default article type when creating a new 頁面. */
  articleType?: Maybe<RankMathArticleTypeEnum>;
  /** Default description for single 頁面 pages. */
  description?: Maybe<Scalars['String']['output']>;
  ...
  /** Default rich snippet select when creating a new 頁面. */
  ...
  /** Default title tag for single 頁面 pages. */
  title?: Maybe<Scalars['String']['output']>;
};
...
export type Post = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithAuthor & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithRankMathSeo & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Post';
  /**
...
/** The RankMath SEO meta settings for 文章格式. */
...
/** The RankMath SEO meta settings for 文章. */
export type PostMetaSettings = RankMathMetaSettingWithRobots & {
  ...
  /** List of custom fields name to include in the Page analysis */
  analyzedFields?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  /** Default article type when creating a new 文章. */
  articleType?: Maybe<RankMathArticleTypeEnum>;
  /** Default description for single 文章 pages. */
  description?: Maybe<Scalars['String']['output']>;
  /** Whether to list bulk editing columns to the post listing screen. */
  hasBulkEditing?: Maybe<RankMathBulkEditingTypeEnum>;
  /** Whether custom robots meta for author page are set. Otherwise the default meta will be used, as set in the Global Meta tab. */
  ...
  /** Default rich snippet headline. */
  snippetHeadline?: Maybe<Scalars['String']['output']>;
  /** Default rich snippet select when creating a new 文章. */
  snippetType?: Maybe<RankMathSnippetTypeEnum>;
  /** The default image to display when sharing this post type on social media */
  socialImage?: Maybe<MediaItem>;
  /** Default title tag for single 文章 pages. */
  title?: Maybe<Scalars['String']['output']>;
};
...
/** A paginated collection of RankMathRedirection Nodes, Supports cursor-based pagination and filtering to efficiently retrieve sets of RankMathRedirection Nodes */
...
/** Represents a connection to a RankMathRedirection. Contains both the RankMathRedirection Node and metadata about the relationship. */
...
/** Pagination metadata specific to &quot;RankMathRedirectionConnectionEdge&quot; collections. Provides cursors and flags for navigating through sets of &quot;RankMathRedirectionConnectionEdge&quot; Nodes. */
...
export type RankMathTaxonomyMetaSettings = {
  ...
  /** The RankMath SEO meta settings for 標籤. */
...
/** Pagination metadata specific to &quot;RootQueryToRankMathRedirectionConnection&quot; collections. Provides cursors and flags for navigating through sets of RootQueryToRankMathRedirectionConnection Nodes. */
...
export type GetAllPageSlugsQuery = { __typename?: 'RootQuery', pages?: { __typename?: 'RootQueryToPageConnection', nodes: Array<{ __typename?: 'Page', slug?: string | null }> } | null };
...
export type GetPostsAndSiteInfoQuery = { __typename?: 'RootQuery', posts?: { __typename?: 'RootQueryToPostConnection', nodes: Array<{ __typename?: 'Post', title?: string | null, date?: string | null }> } | null, generalSettings?: { __typename?: 'GeneralSettings', title?: string | null, description?: string | null } | null };

export type AnalyzeSiteStructureQueryVariables = Exact<{ [key: string]: never; }>;


export type AnalyzeSiteStructureQuery = { __typename?: 'RootQuery', contentTypes?: { __typename?: 'RootQueryToContentTypeConnection', nodes: Array<{ __typename?: 'ContentType', name?: string | null, label?: string | null, graphqlSingleName?: string | null, graphqlPluralName?: string | null }> } | null, categories?: { __typename?: 'RootQueryToCategoryConnection', nodes: Array<{ __typename?: 'Category', name?: string | null, slug?: string | null, count?: number | null }> } | null, tags?: { __typename?: 'RootQueryToTagConnection', nodes: Array<{ __typename?: 'Tag', name?: string | null, slug?: string | null, count?: number | null }> } | null, pages?: { __typename?: 'RootQueryToPageConnection', nodes: Array<{ __typename?: 'Page', title?: string | null, slug?: string | null, uri?: string | null, parentId?: string | null }> } | null, posts?: { __typename?: 'RootQueryToPostConnection', nodes: Array<{ __typename?: 'Post', title?: string | null, slug?: string | null, uri?: string | null, date?: string | null, categories?: { __typename?: 'PostToCategoryConnection', nodes: Array<{ __typename?: 'Category', name?: string | null, slug?: string | null }> } | null }> } | null, menus?: { __typename?: 'RootQueryToMenuConnection', nodes: Array<{ __typename?: 'Menu', name?: string | null, slug?: string | null, locations?: Array<MenuLocationEnum | null> | null }> } | null };
...
export const GetAllPostSlugsDocument = new TypedDocumentString(`
  ...
  posts(first: 1000) {
    ...
    `) as unknown as TypedDocumentString<GetAllPostSlugsQuery, GetAllPostSlugsQueryVariables>;
export const GetAllPageSlugsDocument = new TypedDocumentString(`
  ...
  pages(first: 1000) {
    ...
    `) as unknown as TypedDocumentString<GetAllPageSlugsQuery, GetAllPageSlugsQueryVariables>;
export const GetHomepageContentDocument = new TypedDocumentString(`
...
export const GetPostsAndSiteInfoDocument = new TypedDocumentString(`
  ...
  generalSettings {
    ...
    `) as unknown as TypedDocumentString<GetPostsAndSiteInfoQuery, GetPostsAndSiteInfoQueryVariables>;
export const AnalyzeSiteStructureDocument = new TypedDocumentString(`
  ...
  menus {
    ...
    `) as unknown as TypedDocumentString<AnalyzeSiteStructureQuery, AnalyzeSiteStructureQueryVariables>;