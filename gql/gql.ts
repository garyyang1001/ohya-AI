...
const documents: Documents = {
    ...
    "query GetMenuByLocation($location: MenuLocationEnum!) {\n  menuItems(where: {location: $location}, first: 50) {\n    nodes {\n      id\n      label\n      url\n      path\n      parentId\n      cssClasses\n      target\n      order\n    }\n  }\n}\n\nquery GetAllMenus {\n  menus {\n    nodes {\n      id\n      name\n      slug\n      locations\n      menuItems {\n        nodes {\n          id\n          label\n          url\n          path\n          parentId\n          order\n        }\n      }\n    }\n  }\n}": types.GetMenuByLocationDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetMenuByLocation($location: MenuLocationEnum!) {\n  menuItems(where: {location: $location}, first: 50) {\n    nodes {\n      id\n      label\n      url\n      path\n      parentId\n      cssClasses\n      target\n      order\n    }\n  }\n}\n\nquery GetAllMenus {\n  menus {\n    nodes {\n      id\n      name\n      slug\n      locations\n      menuItems {\n        nodes {\n          id\n          label\n          url\n          path\n          parentId\n          order\n        }\n      }\n    }\n  }\n}"): typeof import('./graphql').GetMenuByLocationDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
